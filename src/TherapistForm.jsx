...
const TherapistForm = ({ onFormSubmit, navigateToMap }) => {
  ...
  if (isSubmitted) {
    return (
      <div className="form-container" >
        ...
        <br></br>
        <button onClick={navigateToMap} className='cont-button'>קחו אותי למאגר</button>
      </div>
    );
  }
  ...
  return (
    <div className="form-container">
      <div className="step-indicators">
        ...
        <span className={`step ${currentStep === 3 ? 'active' : ''}`}>3. חשוב שנדע</span>
      </div>
